...
var name=document.querySelectorAll(".drum").length
...
function soundAnime(currentani){
    var activebutton=document.querySelector("." + currentani);
